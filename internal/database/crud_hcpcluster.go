...
type OperationCRUD interface {
	...
	ListActiveOperations(options *ARMResourcesDBClientListActiveOperationDocsOptions) ARMResourcesDBClientIterator[api.Operation]
}
...
func (d *operationCRUD) ListActiveOperations(options *ARMResourcesDBClientListActiveOperationDocsOptions) ARMResourcesDBClientIterator[api.Operation] {
