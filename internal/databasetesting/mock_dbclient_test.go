...
func TestMockARMResourcesDBClient_LoadFromDirectory(t *testing.T) {
	...
	mock := NewMockARMResourcesDBClient()
...
func TestMockARMResourcesDBClient_LoadAndQuery(t *testing.T) {
	// Load test data
	testDataDir := filepath.Join("..", "..", "test-integration", "frontend", "artifacts", "FrontendCRUD", "NodePool", "read-old-data", "01-load-old-data")
...
func TestMockARMResourcesDBClient_CRUD_Cluster(t *testing.T) {
	mock := NewMockARMResourcesDBClient()
	ctx := context.Background()
...
func TestMockARMResourcesDBClient_CRUD_Operation(t *testing.T) {
	mock := NewMockARMResourcesDBClient()
	ctx := context.Background()
	...
	iterFiltered := operationCRUD.ListActiveOperations(&database.ARMResourcesDBClientListActiveOperationDocsOptions{
...
func TestMockARMResourcesDBClient_CRUD_Subscription(t *testing.T) {
	mock := NewMockARMResourcesDBClient()
	ctx := context.Background()
...
func TestMockARMResourcesDBClient_Transaction(t *testing.T) {
	mock := NewMockARMResourcesDBClient()
	ctx := context.Background()
...
func TestMockARMResourcesDBClient_UntypedCRUD(t *testing.T) {
	mock := NewMockARMResourcesDBClient()
	ctx := context.Background()
...
func TestMockARMResourcesDBClient_StoreAndRetrieveRawDocument(t *testing.T) {
	mock := NewMockARMResourcesDBClient()
...
func TestMockARMResourcesDBClient_Clear(t *testing.T) {
	mock := NewMockARMResourcesDBClient()
...
func TestMockARMResourcesDBClient_ServiceProviderCluster_ETagConditionalReplace(t *testing.T) {
	mock := NewMockARMResourcesDBClient()
	ctx := context.Background()
...
func TestMockARMResourcesDBClient_Controller_ETagConditionalReplace(t *testing.T) {
	mock := NewMockARMResourcesDBClient()
	ctx := context.Background()
...
func TestMockARMResourcesDBClient_addResource(t *testing.T) {
	ctx := context.Background()
	mock := NewMockARMResourcesDBClient()
...
func TestNewMockARMResourcesDBClientWithResources(t *testing.T) {
	ctx := context.Background()
	...
	// Create MockARMResourcesDBClient with all resources
	mock, err := NewMockARMResourcesDBClientWithResources(ctx, []any{cluster, nodePool, subscription})
	if err != nil {
...
func TestNewMockARMResourcesDBClientWithResources_Error(t *testing.T) {
	ctx := context.Background()

	// Test with unsupported type
	_, err := NewMockARMResourcesDBClientWithResources(ctx, []any{"unsupported"})
	if err == nil {
		t.Error("Expected error for unsupported type")
	}
	...
	_, err = NewMockARMResourcesDBClientWithResources(ctx, []any{clusterWithNilID})
	if err == nil {
