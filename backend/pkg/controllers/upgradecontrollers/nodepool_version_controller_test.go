...
func createTestSubscription(t *testing.T, ctx context.Context, mockDB *databasetesting.MockResourcesDBClient) {
	t.Helper()
...
func createTestNodePoolWithVersion(t *testing.T, ctx context.Context, mockDB *databasetesting.MockResourcesDBClient, desiredVersion string) {
	t.Helper()
...
func createServiceProviderClusterWithVersion(t *testing.T, ctx context.Context, mockDB *databasetesting.MockResourcesDBClient, controlPlaneVersion string) {
	t.Helper()
...
func createServiceProviderNodePoolWithVersion(t *testing.T, ctx context.Context, mockDB *databasetesting.MockResourcesDBClient, activeVersion string) {
	t.Helper()
