...
func NewCosmosCRUD[InternalAPIType any](t *testing.T, cosmosClient database.ARMResourcesDBClient, parentResourceID *azcorearm.ResourceID, resourceType azcorearm.ResourceType) database.ResourceCRUD[InternalAPIType] {
	switch {
