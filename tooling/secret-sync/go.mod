...
require (
	github.com/Azure/ARO-Tools/config v0.0.0-20260428151533-4096ffac2e16 // indirect
	github.com/Azure/ARO-Tools/testutil v0.0.0-20260428151533-4096ffac2e16 // indirect
