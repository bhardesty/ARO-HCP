...
require (
	github.com/Azure/ARO-Tools/config v0.0.0-20260426235717-a3cbc0ea0ef1 // indirect
	github.com/Azure/ARO-Tools/testutil v0.0.0-20260426235717-a3cbc0ea0ef1 // indirect
